...
РОУТЕР ЗАПРОСОВ
    |
    |-- ГРУППА А: ПОЛЬЗОВАТЕЛИ (Вертикальный шаринг)
    |   |-- Сервер 1: пользователи A-M (Горизонтальный)
    |   |-- Сервер 2: пользователи N-Z (Горизонтальный)
    |
    |-- ГРУППА Б: КНИГИ + МАГАЗИНЫ (Вертикальный шаринг)  
    |   |-- Сервер 3: книги художественные (Горизонтальный)
    |   |-- Сервер 4: книги технические (Горизонтальный)
    |   |-- Сервер 5: магазины Европа (Горизонтальный)
    |   |-- Сервер 6: магазины Азия/Америка (Горизонтальный)

**Таблица распределения:**

| Сервер | Таблица      | Данные         | Тип шаринга    |
|--------|---------     |--------        |-------------   |
| 1      | пользователи | A-M            | Горизонтальный |
| 2      | пользователи | N-Z            | Горизонтальный |
| 3      | книги        | Художественные | Горизонтальный |
| 4      | книги        | Технические    | Горизонтальный |
| 5      | магазины     | Европа         | Горизонтальный |
| 6      | магазины     | Азия/Америка   | Горизонтальный |
